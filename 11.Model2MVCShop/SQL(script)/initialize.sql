...
VALUES ( 'admin', 'admin', '1234', 'admin', NULL, NULL, 'admin@mvc.com',to_date('2012/01/14 10:48:43', 'YYYY/MM/DD HH24:MI:SS'), '13536', '경기 성남시 분당구 판교역로 4 (백현동)', NULL); 

INSERT 
INTO users ( user_id, user_name, password, role, ssn, cell_phone, email, reg_date, postcode, address, address2 ) 
VALUES ( 'manager', 'manager', '1234', 'admin', NULL, NULL, 'manager@mvc.com', to_date('2012/01/14 10:48:43', 'YYYY/MM/DD HH24:MI:SS'), '63308', '제주특별자치도 제주시 구릉동산길 13 (영평동)', NULL);          
