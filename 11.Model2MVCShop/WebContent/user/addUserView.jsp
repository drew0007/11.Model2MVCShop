	...
	<div class="container">
		...
		<input 	type="hidden" name="type" value="${type}">
		  ...
		  <div class="form-group" ${empty userId2?'':'hidden'}>
		    ...
		    <div class="col-sm-4">
		      	<input type="text" class="form-control" 
		      		id="userId" name="userId" placeholder="아이디" value="${userId2}">
		    </div>
		  ...
		  <div class="form-group" ${empty userId2?'':'hidden'}>
		    ...
		    <div class="col-sm-4">
		      	<input type="password" class="form-control" 
		      		id="password" name="password" placeholder="비밀번호" value="${userId2}">
		    </div>
		  </div>
		  ...
		  <div class="form-group" ${empty userId2?'':'hidden'}>
		    ...
		    <div class="col-sm-4">
		      	<input type="password" class="form-control" 
		      		id="password2" name="password2" placeholder="비밀번호 확인" value="${userId2}">
		    </div>
		  </div>
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      	<input type="text" class="form-control" 
		      		id="userName" name="userName" placeholder="회원이름" value="${user.userName}">
		    </div>
		  </div>
