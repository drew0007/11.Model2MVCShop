...
<script type="text/javascript">
	...
	$(function(){
		...
		$("td:nth-child(11)").on("click", function(){
			...
			var index = $("td:nth-child(11)").index(this);
			var prodNo = $($("input[name='prodNoList']")[index]).val();
			var prodName = $($("input[name='prodName']")[index]).val();
			var tranNo = $($("input[name='tranNoList']")[index]).val();
			var tranCnt = $($("input[name='tranCntList']")[index]).val();
			var text = $($("td:nth-child(11)")[index]).text().trim();
					...
					$.ajax( 
							{
								...
								success : function(JSONData , status) {
									$($("td:nth-child(10)")[index]).text('배송중 상태');
									$($("td:nth-child(11)")[index]).text('');
									alert('배송상태 변경 완료');
								}
							});
				}else{
					...
					$.ajax( 
							{
								...
								success : function(JSONData , status) {
									$($("td:nth-child(10)")[index]).text('구매취소 상태');
									$($("td:nth-child(11)")[index]).text('');
									alert('구매취소상태 변경 완료');
								}
							});
